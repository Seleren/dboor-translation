...
define( "LANGUI_ALLIANCE_T2", "You are not currently in any alliance. To join an alliance you need an Embassy level 1, as well as the invitation of the alliance." );
...
define( "LANGUI_ALLIANCE_T15", "Are you sure you want to kick this player from the alliance ?" );
define( "LANGUI_ALLIANCE_T16", "Players" );
define( "LANGUI_ALLIANCE_T17", "Population" );
define( "LANGUI_ALLIANCE_T18", "Villages" );
define( "LANGUI_ALLIANCE_T19", "Remove the player from the alliance" );
define( "LANGUI_ALLIANCE_T20", "Alliance ranks" );
...
define( "LANGUI_ALLIANCE_T31", "Invite a player to the alliance" );
define( "LANGUI_ALLIANCE_T32", "Alliance diplomacy" );
define( "LANGUI_ALLIANCE_T33", "Leave the coalition" );
define( "LANGUI_ALLIANCE_T34", "For security reasons, please enter your password to leave the alliance" );
...
define( "LANGUI_ALLIANCE_T39", "Diplomatic behavior makes it imperative to communicate with each other before sending the alliance not to display aggression." );
...
define( "LANGUI_ALLIANCE_T47", "To view the covenants don't write assaulted" );
...
define( "LANGUI_ALLIANCE_T52", "No player with that name" );
